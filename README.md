...
Рабочую версию сайта вы можете посмотреть по ссылке [max-burger.site](https://max-burger.site)
...
Определите переменную окружения `SECRET_KEY`. Создать файл `.env` в каталоге
`star_burger/` и положите туда такой код, где заначения констант будут
похожи на эти:
```sh
...
- `YANDEX_API_KEY` — 6cd6d599-de18-5r5r-a877-153ffb3c1v1v.
- `ROLLBAR_TOKEN` - 56765c434cbhhh555ggg444fff777   # optional
